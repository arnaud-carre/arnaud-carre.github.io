...
And now what about breaking the 4096 colors (12bits) limit of the Amiga? We have 16 levels of shade only ( 0 to 15 ). Let's suppose we flip the shade level of a pixel between 5 and 6, each frame ( 50hz ). We may see some flickering, but our eye will see kinda "in between" shade levels, like 5.5.
...
[Download SHAM5b Amiga Executable Disk Image](https://arnaud-carre.github.io/assets/img/ham/sham5b.adf)
...
This code is part of my abc2 tool ( AmigAtari Bitmap Converter ). I will soon release it on github so you guys could have fun with it and improve.
